...
CASE WHEN YEAR = 2013 THEN 500000 WHEN YEAR = 2014 THEN 400000 END AS TOTAL_BONUS,
ROUND(TOTAL_BONUS*(SALE/TOTAL_SALE),2) AS BONUS_PROPORTION,
...
(SELECT D.YEAR, L.STATE_PROVINCE, S.STORENUMBER, A.CNT_STORE,
SUM(FSA.SALEQUANTITY) AS QUANTITY,
SUM(FSA.SALEAMOUNT) AS SALE,
SUM(FSA.SALETOTALPROFIT) AS PROFIT,
...
WHERE L.STATE_PROVINCE <> 'Unknown'
GROUP BY D.YEAR, L.STATE_PROVINCE, A.CNT_STORE, STORENUMBER
